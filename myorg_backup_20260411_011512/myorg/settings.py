...
SECRET_KEY = 'django-insecure-&_kp35(x59wck%_o7g4pdds82fi5o&qb0uyo7)6v4i3#3#e$()'
DEBUG = True
...
MARKETPLACE_INTEGRATIONS = {
    'amazon': {
        'enabled': os.getenv('AMAZON_API_ENABLED', 'false').lower() == 'true',
        ...
        'search_index': os.getenv('AMAZON_SEARCH_INDEX', 'All'),
    },
    'flipkart': {
        'enabled': os.getenv('FLIPKART_API_ENABLED', 'false').lower() == 'true',
        'affiliate_id': os.getenv('FLIPKART_AFFILIATE_ID', ''),
        'affiliate_token': os.getenv('FLIPKART_AFFILIATE_TOKEN', ''),
        'api_base': os.getenv('FLIPKART_API_BASE', 'https://affiliate-api.flipkart.net/affiliate/1.0'),
    },
}
